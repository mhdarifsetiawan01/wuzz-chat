...
- ⏳ **Fase 8: Core Parity (Push Notifications, Group Chat & Message Management) (SEDANG BERJALAN)** —
  ...
  18. 🎯 **Milestone 8.9: Mobile-Ready Reliability (Request ID + ACK Protocol & Server-Side In-Memory Idempotency) (NEXT)**: Transport ACK deterministik, deduplikasi pesan server berbasis in-memory cache 2 menit, dan katalog DTO resmi untuk developer mobile Android Native & React Native.
  19. ⏳ **Milestone 8.3: Message Management Suite (PLANNED 🔮)**: Edit pesan (15 menit), forward pesan multi-kontak, pin chat & pin message, starred message, dan in-chat search.
