...
- ⏳ **Fase 8: Core Parity (Push Notifications, Group Chat & Message Management) (SEDANG BERJALAN)** —
  ...
  12. 🎯 **Milestone 8.2: Group Chat Engine & Member Management / Bad Words Sensor Filter (NEXT)**: Percakapan multi-user, multicast WebSocket broadcast, role Admin/Member, modal buat grup, Group Info Drawer, dan sistem sensor kata-kata.
  13. ⏳ **Milestone 8.3: Message Management Suite**: Edit pesan (15 menit), forward pesan, pin chat & pin message, starred message, dan in-chat search.
