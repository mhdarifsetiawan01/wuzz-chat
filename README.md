...
- [x] **Ephemeral Sub-Groups & TTL Lifecycle Engine (Fase 8 Milestone 8.2B)**: Mini ruang obrolan bertopik di dalam grup induk dengan identitas unik `sub_<UUIDv4>` dan TTL otomatis. Dilengkapi dengan:
  ...
  - **UI/UX Aurora Glassmorphism**: `SubGroupListDrawer.tsx` dengan badge hitungan mundur dinamis, `CreateSubGroupModal.tsx`, dan navigasi kembali `← [Nama Grup Induk]`.
